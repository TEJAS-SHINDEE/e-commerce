    ...
    <>
        <aside className='h-full w-[12%] hidden md:inline'> 
                ...
                <ul className='text-[.93rem] leading-7 text-black'>
                    ...
                    <li className='hover:underline underline-offset-4'><a href="/trending">Trending</a></li>
                    <li className='hover:underline underline-offset-4'><a href="#">Latest Arrivals</a></li>
                    <li className='hover:underline underline-offset-4'><a href="/search/low">Price: Low to High</a></li>
                    <li className='hover:underline underline-offset-4'><a href="/search/high">Price: High to Low</a></li>
                </ul>
        </aside>
    </>
    );
