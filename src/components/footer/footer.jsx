...
export function Footer() {
	return (
		<>
			<div className="">
				<div className="main-footer mx-auto flex flex-row py-12 px-6 m-auto gap-6 text-sm">
					<div className="flex flex-row justify-center gap-2">
						...
						<p className="text-sm text-black cursor-pointer flex justify-center pt-1">
							ACME STORE
						</p>
					</div>
					<div>
						<ul>
							<li>
								<a
									className="block text-black underline-offset-4 p-2 hover:underline"
									href="/"
								>
									Home
								</a>
							...
							<li>
								<a
									className="block text-gray-500 hover:text-black underline-offset-4 p-2 hover:underline"
									href="/about"
								>
									About
								</a>
				...
				<div className="sub-footer text-gray-500  border-t border-gray-300 py-6 px-4">
					<div className="flex flex-col  items-center text-sm md:flex-row">
						<p>
							<i className="ri-copyright-line"> </i> 2023-2025 ACME, Inc. All
							Right reserved.
						</p>
						<p className="px-4 text-gray-500"> | </p>
						<p>
							<a href="https://github.com/" className="md:ml-auto ">
								View the source
							</a>
						</p>
